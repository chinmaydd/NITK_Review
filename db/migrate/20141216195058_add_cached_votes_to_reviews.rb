class AddCachedVotesToReviews < ActiveRecord::Migration
    ...
    add_column :reviews, :cached_weighted_score, :integer, :default => 0
    add_column :reviews, :cached_weighted_total, :integer, :default => 0
    add_column :reviews, :cached_weighted_average, :float, :default => 0.0
  ...
  def self.down
    remove_column :reviews, :cached_votes_total
    remove_column :reviews, :cached_votes_score
    remove_column :reviews, :cached_votes_up
    remove_column :reviews, :cached_votes_down
    remove_column :reviews, :cached_weighted_score
    remove_column :reviews, :cached_weighted_total
    remove_column :reviews, :cached_weighted_average
  end
end
